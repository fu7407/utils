...
public class Test {
    ...
    public String getSum(int []array,int n){
    	...
    	for(int i=0;i<array.length;i++){
    		...
    		for(int j=i+1;j<array.length;j++){
    			if(array[i]+array[j]==n)sb.append("{").append(array[i]).append(",").append(array[j]).append("}");
    		}
    	}
    	return sb.toString();
    }
    ...
    public void get(){
    	for(int a=1;a<10;a++){
    		for(int b=1;b<10;b++){
    			for(int c=1;c<10;c++){
    				if((a*100+b*10+c)<(a*100+c*10+b)&&(a*100+b*10+c)<(b*100+a*10+c)&&(a*100+b*10+c)<(b*100+c*10+a)
    						&&(a*100+b*10+c)<(c*100+a*10+b)&&(a*100+b*10+c)<(c*100+b*10+a)){

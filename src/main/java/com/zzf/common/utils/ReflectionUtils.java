...
public class ReflectionUtils {
    ...
    public static List<Object> fetchElementPropertyToList(Collection<Object> collection, String propertyName) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static String fetchElementPropertyToString(Collection<Object> collection, String propertyName,
            String seperator) {
